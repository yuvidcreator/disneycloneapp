                ...
                <section className="relative z-50">
                    ...
                    <div className="absolute inset-y-48 md:inset-y-auto md:bottom-20 inset-x-4 md:inset-x-12 space-y-6 z-50">
                        ...
                        <p className='text-sm md:text-sm'>
                            ...
                            {result.number_of_seasons === 1 ? "Season": "Seasons"} &bull;{" "}
...
export async function getServerSideProps(context) {
    ...
    const request = await fetch(`https://api.themoviedb.org/3/tv/${id}?api_key=${process.env.MV_API_KEY}&language=en-US&append_to_response=videos`).then((response) => response.json());
